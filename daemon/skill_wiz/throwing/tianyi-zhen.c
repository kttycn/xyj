...
int practice_skill(object me)
{
	...
	if ((int)me->query("kee") < 50)
		return notify_fail("ÄãµÄÌåÁ¦²»¹»Á·ÌìÒÂÉñÕë¡£\n");
...
int apperception_skill(object me)
{
	...
	|| (int)me->query("force") < 10 )
		return notify_fail("ÄãµÄÄÚÁ¦¡¢¾«Éñ»òÆø²»¹»£¬Ã»ÓÐ°ì·¨²ÎÎòÌìÒÂÉñÕë¡£\n");
	me->receive_damage("kee", 60);
	me->add("force", -10);
	write("Äã°´×ÅËùÑ§²ÎÎòÌìÒÂÉñÕë¡£\n");
	return 1;
}
...
void skill_improved(object me)
{
   ...
   if(m_skill>200&&m_skill%10==0){
     tell_object(me,HIW"Äã¶ÔÌìÒÂÉñÕëµÄÁìÎò¼ÓÉîÁË£¬ÄãµÄÌìÒÂÉñÕë½øÈëÁËÒ»¸öÐÂµÄ¾³½ç£¡\n"NOR);
     ...
     tell_object(me,HIW"ÄãÍ»È»¸£ÖÁÐÄÁé£¬¶ÔÌìÒÂÉñÕëÁìÎò³öÁËÒ»ÕÐÐÂµÄÓÃ·¨£¡\n"NOR);
...
void name_skill(object me, string arg)
{
   ...
   if(!arg||arg==" ")arg="ÌìÒÂÉñÕë¾ø¼¼"+chinese_number(sizeof(m_actions)+1);
   m_act+=(["name":arg]);
