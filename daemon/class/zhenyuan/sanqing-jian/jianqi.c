...
int perform(object me, object target)
{
	...
	&& !me->query("guild") )
		return notify_fail("[剑芒三连击]是五庄观不传之密！\n");
...
int perform2(object me, object target)
{
	...
	else    if( force_skill=="ningxue-force" ) force_skill_name = "凝血神功";
	...
	else    if( force_skill=="xiantian-force" ) force_skill_name = "先天乾坤功";
	else    if( force_skill=="guiyuanforce" ) force_skill_name = "归元神功";
	else    if( force_skill=="wuzu-xinfa" ) force_skill_name = "无祖心法";
