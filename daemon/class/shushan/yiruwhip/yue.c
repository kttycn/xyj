...
int perform(object me, object target)
{
	...
	mjianh= (int)me->query_skill("yiruwhip",1);
	...
	if(me->query("shushan/yue_perform")!=1)
		return notify_fail("你还没领会「冷浸溶溶月」！\n");

	if ( mjianh < 100)
		return notify_fail("你的思如鞭法还不够火候！\n");
	if ( (int)me->query_skill("taoism",1) < 100)
		return notify_fail("你的天师仙法还不够火候！\n");
