...
int perform(object me, object target)
{
	...
	ap2 = (int)me->query_skill("jueqing-whip",1);
	...
	if(success == 1 ){
		...
		howlong = random(me->query_skill("jueqing-whip",1)+me->query_skill("moonshentong",1))/10+5;
...
{
	if (me->query_temp("qingwang"))
		destruct(me->query_temp("qingwang"));
	if (!target) return;
