...
int valid_learn(object me)
{
	...
	if (me->query_skill("dragonforce", 1) < me->query_skill("dragon-cha", 1)/2)
...
//   int mylev=me->query("dragon-cha", 1);
//  string msg;
...
int apperception_skill(object me)
{
	...
	|| (int)me->query("force") < 10 )
		return notify_fail("你的内力、精神或气不够，没有办法参悟风波十二叉。\n");
...
{
	return CLASS_D("dragon") + "/dragon-cha/" + func;
}
