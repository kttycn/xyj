...
void create()
{
	set_name(HIG"照妖镜"NOR, ({"zhaoyao jing", "jing", "mirror"}));
	set_weight(20000);
	if( clonep() )
		...
		set("value", 8000000);
	        set("no_put", 1);
		set("long", "这面古镜径有八寸，镜鼻是一匹蹲伏的麒麟；镜鼻四边，灵龟、赤凤、
青龙，白虎，依北、南、东，西方位排列；四方外又列着八卦；卦外
列十二地支及生肖动物；生肖之外，又列有二十四字环绕着镜子轮廓，
就二十四字，字体好像是隶书。其实是二十四言
一望而知是一件降魔除妖的法器。\n");
		set("wield_msg", "$N一声清咤，反手拔取背上天龙竹杖，一声拂号，竹吐青光。\n");
...
int ji(string target)
{
    ...
    msg="$N从背后抽出一条"HIG"天龙竹杖"NOR"，手挽卍字诀，将"+objname+"对空一丢，喝道：“请佛宝降魔！”\n";
	...
	break;
      case 0:
	msg+=HIB"$n伸手一指，大喝一声“落！”只见青龙变回天龙竹杖，落回$N手中。\n"NOR;
	break;
      case -1:
	...
	break;
      case -2:
	msg+=HIB"$n伸手一指，大喝一声“收！”只见青龙变回天龙竹杖，落入$n手中。\n"NOR;
