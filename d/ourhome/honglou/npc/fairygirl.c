...
string ask_shuizhu()
{
	...
	if ( present("shui lingzhu",who) || present("sheng lingzhu",who) )
		return "可你现在不正拿着一颗吗，人可不能太贪心啊。\n";
...
int ask_qingsuojian()
{
	...
	who = this_player();
	me = this_object();
	if(!who->query_temp("ask_xiwangmu"))
		return 0;
