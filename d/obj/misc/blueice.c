...
int do_make(string arg)
{
	...
	if( (int)me->query("force") < 200 || (int)me->query_skill("ningxue-force", 1) < 20 )
	{
...
{	
	...
	if( (int)this_player()->query("force") < 200 || (int)this_player()->query_skill("ningxue-force", 1) < 20 )
