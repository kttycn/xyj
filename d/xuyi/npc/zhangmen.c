...
void create()
{
   set_name("伏魔神将", ({ "shen jiang", "shenjiang","jiang","zhangmen","zhang men" }) );
...
void reset_me (object me)
{
   ...
   me->set_name("伏魔神将", ({ "shen jiang", "shenjiang","zhang men","zhangmen" }) );
   me->set("gender", "男性" );
   me->set("title","伏魔神将");
...
int accept_fight(object ob)
{
   ...
   {
     command ("say 失陪了！\n");
     return notify_fail("这位伏魔神将尚在比武之中，请稍候。\n");
   }

   if (ob->query_temp("jjf_zm_applied"))
   {
     command("say 好！我们便切磋一下，尚请未来的伏魔神将手下留情。\n");
   }
   else
   {
