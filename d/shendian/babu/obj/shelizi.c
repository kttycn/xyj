...
void create()
{
	set_name(HIR"舍利子"NOR, ({HIR"sheli zi"NOR}));
	set_weight(800);
	if (clonep())
...
case "whip":
	...
	break;
case "mace":
	message_vision(WHT"\n$N轻轻的摸了一下"NOR+HIR"舍利子"NOR+WHT"，只见白光一闪，"+HIR" 舍利子 "NOR+WHT"不由自主的散开，形成一把"NOR+HIR" 奔雷"NOR+HIW"锏 \n"NOR,who);
	message("channel:rumor",YEL+"\n【"+HIB" 八部天龙 "NOR+YEL"】某人："+who->query("name")+"拿到"+HIR" 奔雷"+HIW"锏 "NOR+YEL"了！\n\n"+NOR,users() );
