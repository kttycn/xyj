...
int rank_me()
{
	...
	if( (string)me->query("family/family_name") == "方寸山三星洞"){
		if( exp <= 500000 ) {
			...
			me->set("nick", CYN"方寸方寸"NOR+RED"◆"BLU"迎客道童"NOR);
		} else if(exp <= 2000000 ){
			me->set("nick", CYN"方寸方寸"NOR+RED"◆"YEL"平妖道长"NOR);
		} else if(exp <= 5000000 ){
			me->set("nick", CYN"方寸方寸"NOR+RED"◆"RED"伏魔真人"NOR);
		} else if(exp <= 10000000 ){
			me->set("nick", CYN"方寸方寸"NOR+RED"◆"MAG"御剑天师"NOR);
		} else {
			me->set("nick", CYN"方寸方寸"NOR+RED"◆"CYN"无天老祖"NOR);
		}

		tell_object(me, "云阳真人对你说：你可以做"+me->query("nick")+"。\n");
		tell_room(environment(me),
"云阳真人对"+me->query("name")+"说：你可以做"+me->query("nick")+"。\n", ({me, me}));
...
int do_agree(string arg)
{
	...
	this_player()->query("family/family_name") == "方寸山三星洞") {
