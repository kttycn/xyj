...
string zname(object);
int rank_me();
#define DIRNAME "/d/fenghuang/npc/"

#define MYFILE "/d/fenghuang/npc/zhangmen.c"

void create()
{
	set_name("护国将军", ({ "jiang jun", "jiangjun" }) );
	set("gender", "男性" );
	set("age", 30);
	set("str", 30);
	set("per", 30);
...
void init()
{
	...
	me->create_identity("/d/fenghuang/npc/chenxin", "/d/fenghuang/qianyuan");
...
void reset_me (object me)
{
	...
	me->set_name("护国将军", ({ "jiang jun", "jiangjun" }) );
	me->set("gender", "男性" );
...
string zm_apply()
{
	...
	{
		return "你曾叛师欺祖，言无信行不轨，岂能出任护国将军一职！\n";
	}
	...
	if( (string)ob->query("gender") == "男性" )
		return "好！兄台有意出任护国将军一职？我们就切磋一下吧！\n";
	else return "好！大姊有意出任护国女神一职？我们就切磋一下吧！\n";
}
...
int accept_fight(object ob)
{
	...
	{
		command ("say 失陪了！\n");
		return notify_fail("这位将军尚在比武之中，请稍候。\n");
	}
...
{
	CHANNEL_D->do_channel(who,"chat","本城护国将军"+ob->query("name")+"今日走马上任。恭请各位仙长多加捧场！");
