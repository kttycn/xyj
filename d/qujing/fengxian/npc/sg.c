...
int test_player (object who)
{
	...
	message_vision ("$N说道：多少大师前来凤仙郡救济灾民，"+"去各个庙宇道场祭坛，都尚未有果。\n",me);
...
void check_player (object who)
{
	...
	message_vision ("官人对$N一拜说道：方才天上狂风大作，电闪雷鸣，"+"果然一场好雨。\n",me);
	message_vision ("\n官人退下。\n",me);
	command ("ah");
...
void announce_success (object who)
{
	...
	message("channel:chat",HIW"【过关斩将】上官郡主(Shangguan junzhu)："+who->query("name")+"闯过西行取经第三十二关！\n"NOR,users());
