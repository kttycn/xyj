...
void set_skills(int j, int level)
{
        ...
        me->set_skill("fork", j+random(2));
        me->set_skill("dragon-cha", j+random(2));
        me->set_skill("hammer",j+random(2));
        me->set_skill("huntian-hammer",j+random(2));
        me->set_skill("dragon-steps", j+random(2));
        me->set_skill("dragonfight", j+random(2));
        me->set_skill("dragonforce", j+random(2));
        me->set_skill("seashentong", j+random(2));
