...
LONG);
   ...
   set("chat_msg_combat", ({
	...
	set("chat_msg", ({
		...
		"疥癞和尚大声地喊道：贫僧想卖这件袈裟。\n",
		"疥癞和尚大声地叫道：我这袈裟，龙披一缕，免大鹏吞噬之灾；鹤挂一丝，得超凡入圣之妙。\n但坐处，有万神朝礼；凡举动，有七佛随身。\n",
		"疥癞和尚大声地说道：我这袈裟是冰蚕造练抽丝，巧匠翻腾为线。仙娥织就，神女机成，方方\n簇幅绣花缝，片片相帮堆锦筘。玲珑散碎斗妆花，色亮飘光喷宝艳。\n",
		"疥癞和尚大声地说道：穿上我这袈裟满身红雾绕，脱来一段彩云飞。三天门外透玄光，五岳山\n前生宝气。重重嵌就西番莲，灼灼悬珠星斗象。\n",
		"疥癞和尚大声地叫道：我这袈裟四角上有夜明珠，攒顶间一颗祖母绿。虽无全照原本体，也有\n生光八宝攒。\n",
		"疥癞和尚大声地说道：这袈裟，闲时折叠，遇圣才穿。闲时折叠，千层包裹透虹霓；遇圣才\n穿，惊动诸天神鬼怕。\n",
		"疥癞和尚大声地说道：我这袈裟上边有如意珠，摩尼珠，辟尘珠，定风珠；又有那红玛瑙，紫\n珊瑚，夜明珠，舍利子。偷月沁白，与日争红。\n",
		"疥癞和尚大声地说道：条条仙气盈空，朵朵祥光捧圣。条条仙气盈空，照彻了天关；朵朵样光\n捧圣，影遍了世界。照山川，惊虎豹；影海岛，动鱼龙。\n",
		"疥癞和尚大声地说道：沿边两道销金锁，叩领连环白玉珠。诗曰；三宝巍巍道可尊，四生六道\n尽评论。明心解养人天法，见性能传智慧灯。\n",
...
{       
	...
	me=this_player();
	if ( me->query_temp("ask_dashi") || 
	present(" wucai jiasha", me) )
	{
		message_vision("$N对$n说道：你不是来拿过袈裟了吗？\n",this_object(),me);
		return 1;
	}
	if (me->query("obstacle/hf") =="done")
		return notify_fail("很好，很好！");
...
int do_kill(string arg)
{
  ...
  if (arg)
  {
	message_vision(HIY"$N对着$n叹道：渊渊相报，何时了啊！这位"+RANK_D->query_respect(me)+
			"听我一句，放下屠刀，立地成佛！\n"NOR,ob,me);
	message_vision(HIY"$N听罢，真个不再打下去了。\n"NOR,me);
    return 1;
  }
