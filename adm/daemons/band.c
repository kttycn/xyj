...
int check_ip(string my_ip)
{
   ...
   if(my_ip=="74.192.191.1") return 1; //main site
   if(my_ip=="74.192.191.106") return 1;  //dl mirror
   if(my_ip=="11.133.219.114") return 1; //bj mirror
   if(my_ip=="34.16.191.13") return 1;  //zheda mirror
