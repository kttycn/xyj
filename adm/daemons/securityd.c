...
private nosave mapping wiz_sites;
...
private mapping trusted_read = ([/*可以读*/
    "/": ({ "(admin)","(arch)","(wizard)","(apprentice)","(immortal)","(elder)",})
]);
...
private mapping trusted_write = ([/*可以写*/
     ...
     "obj":    ({ "(wizard)",}),
     "daemon":    ({ "(wizard)",}),
     "doc":   ({ "(wizard)","(apprentice)",}),
]);

private mapping exclude_write = ([/*不能写*/
   "adm":     ({ "(arch)","(wizard)","(apprentice)","(immortal)","(elder)", }),
   "feature": ({ "(arch)","(wizard)","(apprentice)","(immortal)","(elder)",}),
   "log":     ({ "(arch)","(wizard)","(apprentice)","(immortal)","(elder)", }),
   "cmds":    ({ "(arch)","(wizard)","(apprentice)","(immortal)","(elder)",}),
   "u":       ({"(arch)","(wizard)","(apprentice)","(immortal)","(elder)",}),
   "include": ({ "(wizard)","(apprentice)","(immortal)","(elder)", }),
   "data":    ({ "(wizard)","(apprentice)","(immortal)","(elder)",}),
   "std":     ({ "(wizard)","(apprentice)","(immortal)","(elder)",}),
   "d" :      ({ "(apprentice)","(immortal)","(elder)",}),
   "obj" :    ({ "(apprentice)","(immortal)","(elder)",}),
   "daemon" : ({ "(apprentice)","(immortal)","(elder)",}),
   "doc"    : ({ "(apprentice)","(immortal)","(elder)",}),
   "story" : ({ "(apprentice)","(immortal)","(elder)",}),
]);

private mapping exclude_read = ([/*不能读*/
//    "feature":  ({  "(immortal)","(elder)",}),
    "u":        ({  "(apprentice)","(immortal)","(elder)",}),
	"data"    :  ({  "(apprentice)","(immortal)","(elder)",}),
//    "log"    :  ({  "(immortal)","(elder)",}),
]); 
