...
int main(object me, string arg)
{
	...
	if( !arg ) {
		write("你重新投胎。\n");
        tell_object(me, HIR"你感到神情恍忽，宛若进入"HIW"轮回"HIR"，又在遍历六道之界！\n"NOR);
		return 1;
	}
	...
	if(wizardp(me))
	    return notify_fail("请不要自杀掉巫师帐号，谢谢合作！\n");
...
private void check_password(string passwd, object me, int forever)
{
	...
	CHANNEL_D->do_channel(this_object(),"rumor",me->name()+"准备要自杀了。");
...
private int slow_suicide(object me)
{
	...
	write(HIR"永别了，希望月影奇缘曾带给过你一段难忘的时光。。。:(\n"NOR);
